# 🚀 Python & Math Learning Resources for Your AI Journey

## 👋 Welcome

There are plenty of excellent learning resources available across the web, YouTube channels, videos, blog posts, interactive tutorials, and full online courses. You are always encouraged to search for the latest materials and explore alternative explanations that match your learning style.
...
### 📚 Free Books / PDFs
- **Automate the Boring Stuff with Python** – a very beginner-friendly and practical Python book.  
  📌 https://automatetheboringstuff.com/

- **Python for Everybody** (Dr. Charles Severance) – an excellent introduction with exercises and real examples.  
  📌 https://www.py4e.com/book

- **Data Science from Scratch (Joel Grus)** – Python fundamentals with a strong data science mindset.  
...
---
## 📐 Core Math for AI & Machine Learning

A solid math foundation helps you understand how models work, why they behave the way they do, and how to improve them.

### 📘 Free Books / PDFs
- **Mathematics for Machine Learning** – linear algebra, calculus, and probability explained clearly.  
  📌 https://mml-book.github.io/

- **[Introduction to Statistical Learning](https://www.statlearning.com/)** - Excellent book with coverage of key concepts in ML and Stats and python coding, and also a corresponding set of [Video Lectures](https://www.youtube.com/playlist?list=PLoROMvodv4rNHU1-iPeDRH-J0cL-CrIda)
